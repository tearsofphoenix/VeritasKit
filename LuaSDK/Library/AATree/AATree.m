...
- (void) setObject:(id)anObject forKey:(id)aKey {
	...
	[self __lockForWriting];
	AATreeNode *newNode = [[[AATreeNode alloc] initWithData: anObject 
                                                 boundToKey: [aKey copy]] autorelease];
	self->root = [self __insertNode: newNode 
                             atRoot: root];
	[self __unlock];
}
...
- (AATreeNode *) __deleteNodeAtKey: (id)aKey 
                            atRoot: (AATreeNode *)aRoot 
{
...
- (AATreeNode *) __insertNode: (AATreeNode *)aNode
                       atRoot: (AATreeNode *)aRoot 
{
