...
{
    LuaObjCInternal_createMetatable(L, LUA_UIEdgeInsets_METANAME, __LuaUIEdgeInsetMetaMethods);

    LuaObjCInternal_createMetatable(L, LUA_UIOffset_METANAME, __LuaUIOffsetMetaMethods);
