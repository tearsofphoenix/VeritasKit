...
void MsgNew_Scroll_In::pop_up(int timeout) 
{
    ...
    SDL_Rect screen_rect = {static_cast<Sint16>(SCREEN_WIDTH/2 - get_w()/2), 0,
                            static_cast<Uint16>(get_w()), static_cast<Uint16>(get_h())};
    SDL_Rect dest_rect = {0, 0, static_cast<Uint16>(get_w()), static_cast<Uint16>(get_h())};
