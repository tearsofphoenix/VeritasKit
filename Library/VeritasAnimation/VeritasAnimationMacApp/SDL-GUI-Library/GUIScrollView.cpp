...
bool ScrollView::ScrollBarBg::handle_mouse_down(VGPoint coord) {
    ...
    view->move_display_to(VGPoint(0,new_y));
    view->scroll_y_vel = 0;
...
bool ScrollView::ScrollArrow::handle_mouse_down(VGPoint coord) {
...
bool ScrollView::ScrollArrow::handle_mouse_up(VGPoint coord) {
