...
@interface BoCPressFindPasswordPage : BoCPressMetaPage<UIAlertViewDelegate, UITextFieldDelegate>
{
    id<BoCPressAccountDataSource> _findPasswordDataSource;
