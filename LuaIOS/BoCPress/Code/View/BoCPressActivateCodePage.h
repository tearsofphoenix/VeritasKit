...
@protocol BoCPressActivateCodeDataSource;

@class BoCPressActivateCodePagePrivateHandler;

@interface BoCPressActivateCodePage : BoCPressMetaPage< UITextFieldDelegate>
{
    id<BoCPressActivateCodeDataSource> _activateCodeDataSource;
    
    UITextField *_activeCodeTextFiled;
