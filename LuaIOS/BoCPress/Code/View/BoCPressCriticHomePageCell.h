...
@class BoCPressCriticHomePageCellPrivateHandler;

@interface BoCPressCriticHomePageCell : UITableViewCell
{
    
    UIImageView *_thumbnailView;
    
    BoCPressCriticHomePageCellPrivateHandler *_handler;
