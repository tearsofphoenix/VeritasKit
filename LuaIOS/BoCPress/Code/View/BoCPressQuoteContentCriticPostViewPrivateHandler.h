//
//  BoCPressQuoteContentCriticPostViewPrivateHandler.h
//  BoCPress
//
...
@interface BoCPressQuoteContentCriticPostViewPrivateHandler : BoCPressCallback<UITableViewDelegate, UITableViewDataSource>
{
    NSArray *_criticPosts;
