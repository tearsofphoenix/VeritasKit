//
//  BoCPressQuoteContentNewsViewPrivateHandler.h
//  BoCPress
//
...
@interface BoCPressQuoteContentNewsViewPrivateHandler : BoCPressCallback<UITableViewDelegate, UITableViewDataSource>
{
    NSArray *_news;
