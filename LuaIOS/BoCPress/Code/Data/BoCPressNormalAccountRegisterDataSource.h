//
//  BoCPressNormalAccountRegisterDataSource.h
//  BoCPress
//
...
@protocol BoCPressNormalAccountRegisterDataSource<NSObject>
...
@interface BoCPressNormalAccountRegisterDataSource : NSObject<BoCPressNormalAccountRegisterDataSource>
{
