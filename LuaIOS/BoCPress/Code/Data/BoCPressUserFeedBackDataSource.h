//
//  BoCPressUserFeedBackDataSource.h
//  BoCPress
//
...
@protocol BoCPressUserFeedBackDataSource<NSObject>
...
@interface BoCPressUserFeedBackDataSource : NSObject<BoCPressUserFeedBackDataSource>
{
