...
static int lua_CATransform3DIndex(lua_State *L)
{
    ...
    if (VMKCStringEqual(fieldName, "m11"))
    {
        lua_pushnumber(L, t->m11);
        
    }else if (VMKCStringEqual(fieldName, "m12"))
    {
        lua_pushnumber(L, t->m12);
        
    }else if (VMKCStringEqual(fieldName, "m13"))
    {
        lua_pushnumber(L, t->m13);
        
    }else if (VMKCStringEqual(fieldName, "m14"))
    {
        lua_pushnumber(L, t->m14);
        
    }else if (VMKCStringEqual(fieldName, "m21"))
    {
        lua_pushnumber(L, t->m21);
        
    }else if (VMKCStringEqual(fieldName, "m22"))
    {
        lua_pushnumber(L, t->m22);
        
    }else if (VMKCStringEqual(fieldName, "m23"))
    {
        lua_pushnumber(L, t->m23);
        
    }else if (VMKCStringEqual(fieldName, "m24"))
    {
        lua_pushnumber(L, t->m24);
        
    }else if (VMKCStringEqual(fieldName, "m31"))
    {
        lua_pushnumber(L, t->m31);
        
    }else if (VMKCStringEqual(fieldName, "m32"))
    {
        lua_pushnumber(L, t->m32);
        
    }else if (VMKCStringEqual(fieldName, "m33"))
    {
        lua_pushnumber(L, t->m33);
        
    }else if (VMKCStringEqual(fieldName, "m34"))
    {
        lua_pushnumber(L, t->m34);
        
    }else if (VMKCStringEqual(fieldName, "m41"))
    {
        lua_pushnumber(L, t->m41);
        
    }else if (VMKCStringEqual(fieldName, "m42"))
    {
        lua_pushnumber(L, t->m42);
        
    }else if (VMKCStringEqual(fieldName, "m43"))
    {
        lua_pushnumber(L, t->m43);
        
    }else if (VMKCStringEqual(fieldName, "m44"))
    {
